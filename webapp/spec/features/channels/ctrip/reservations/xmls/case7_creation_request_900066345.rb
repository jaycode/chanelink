def case7_creation_request_900066345(date, rtcm)
  <<-EOF
<?xml version="1.0" ?>
  <SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header/>
  <SOAP-ENV:Body><OTA_HotelResRQ Version="2.1" EchoToken="201408212150" xmlns="http://www.opentravel.org/OTA/2003/05">
    <POS>
      <Source>
    ...
    <UniqueID ID="900066345" Type="501" />
    <HotelReservations>
      <HotelReservation>
        <RoomStays>
          <RoomStay>
        ...
        <ResGlobalInfo>
          ...
          <HotelReservationIDs>
            <HotelReservationID ResID_Type="501" ResID_Value="900066345" />
          </HotelReservationIDs>
        </ResGlobalInfo>
      </HotelReservation>
    </HotelReservations>

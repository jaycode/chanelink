def case3_request_900066321(date, rtcm)
  <<-EOF
<?xml version="1.0" ?>
  <SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header/>
  <SOAP-ENV:Body><OTA_HotelResRQ Version="2.1" EchoToken="201408212124" xmlns="http://www.opentravel.org/OTA/2003/05">
    <POS>
      <Source>
    ...
    <UniqueID ID="900066321" Type="501" />
    <HotelReservations>
      <HotelReservation>
        <RoomStays>
          <RoomStay>
            ...
            <RoomRates>
              <RoomRate RatePlanCode="#{rtcm.ota_room_type_id}" RatePlanCategory="16" NumberOfUnits="20">
                <Rates>
                  <Rate EffectiveDate="#{date.to_s}" ExpireDate="#{(date + 28.days).to_s}">
        ...
        <ResGlobalInfo>
          ...
          <TimeSpan Start="#{date.to_s} 0:00:00" End="#{(date + 28.days).to_s} 0:00:00" />
          <SpecialRequests>
            <SpecialRequest>
              <Text Language="en-us" TextFormat="PlainText"></Text><ListItem ListItem="2">try to arrange nonsmoking room</ListItem>
          ...
          <Total AmountAfterTax="203280" CurrencyCode="SGD" />
          <TPA_Extensions>
            <IsReserved>false</IsReserved>
          </TPA_Extensions>
          <HotelReservationIDs>
            <HotelReservationID ResID_Type="501" ResID_Value="900066321" />
          </HotelReservationIDs>
        </ResGlobalInfo>
      </HotelReservation>
    </HotelReservations>
